...
//        titleLabel.font = UIFont(name: kFont, size:25.0)
...
//        subTitleTextView.font = UIFont(name: kFont, size:13.0)
    ...
    open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: CustomColor.colorPrimary())
        userAction = action
        return self
    }
